# Sample postprocessing script for plotting the components of a vector from one snapshot.
#
...
c1 = axs[1].pcolormesh(x, y, V[1]'; norm=cnorm1, cmap, shading="nearest")

for i in eachindex(axs)[2:end]
   axs[i].pcolormesh(x, y, V[i]'; norm=cnorm1, cmap, shading="nearest")
end
